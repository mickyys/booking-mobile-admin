...
// in reservaloya_admin/test/auth_remote_data_source_test.dart.
...
class _FakeCredentialsManager_0 extends _i1.SmartFake
  ...
  _FakeCredentialsManager_0(Object parent, Invocation parentInvocation)
    : super(parent, parentInvocation);
}

class _FakeAuthenticationApi_1 extends _i1.SmartFake
    implements _i3.AuthenticationApi {
  _FakeAuthenticationApi_1(Object parent, Invocation parentInvocation)
    : super(parent, parentInvocation);
}

class _FakeWebAuthentication_2 extends _i1.SmartFake
    implements _i4.WebAuthentication {
  _FakeWebAuthentication_2(Object parent, Invocation parentInvocation)
    : super(parent, parentInvocation);
}

class _FakeCredentials_3 extends _i1.SmartFake implements _i5.Credentials {
  _FakeCredentials_3(Object parent, Invocation parentInvocation)
    : super(parent, parentInvocation);
}
...
class MockAuth0 extends _i1.Mock implements _i6.Auth0 {
  ...
  @override
  _i7.Future<Map<String, String>> getDPoPHeaders({
    required String? url,
    ...
    String? tokenType = 'Bearer',
      ...
      (super.noSuchMethod(
            Invocation.method(#getDPoPHeaders, [], {
              #url: url,
              #method: method,
  ...
  @override
  _i7.Future<void> clearDPoPKey() =>
      (super.noSuchMethod(
            Invocation.method(#clearDPoPKey, []),
  ...
  _i7.Future<_i5.Credentials> login({
    ...
    bool? useDPoP = false,
      ...
      (super.noSuchMethod(
            ...
            returnValue: _i7.Future<_i5.Credentials>.value(
              _FakeCredentials_3(
                this,
                Invocation.method(#login, [], {
                  #audience: audience,
...
///
/// See the documentation for Mockito's code generation for more information.
class MockCredentials extends _i1.Mock implements _i5.Credentials {
  MockCredentials() {
    _i1.throwOnMissingStub(this);
  }
  ...
  DateTime get expiresAt =>
      (super.noSuchMethod(
            ...
            returnValue: _FakeDateTime_4(this, Invocation.getter(#expiresAt)),
          )
          as DateTime);
  ...
  @override
  _i5.UserProfile get user =>
      (super.noSuchMethod(
            Invocation.getter(#user),
            returnValue: _FakeUserProfile_5(this, Invocation.getter(#user)),
          )
          as _i5.UserProfile);
